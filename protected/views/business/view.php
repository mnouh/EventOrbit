...
<div class="topMenu">
  <ul>
    <li><?php echo CHtml::link('Events', array("business/$model->bizurl"), array('class'=>'sel')); ?></li>
    <li><?php echo CHtml::link('Reviews', array("reviews/$model->bizurl")); ?></li>
...
<div class="btmArea"> 
  ...
  <div>
  <h2 class="hdings">All Public Events at <?php echo $model->name; ?> (<?php echo $model->publicEventCount;?>) </h2>
  <div>
...
<div class="blocks">
  <div class="headings">
    <table width="100%" border="0" cellpadding="0" cellspacing="3">
      <tr>
        <td width="100"><strong>Nearby Events with Similar Categories </strong></td>
  ...
  <div class="paddTop">
    ...
    'itemView'=>'_close_events',   // refers to the partial view named '_post'
    'pagerCssClass' => 'page',
        'pager'=>array(
            'htmlOptions' => array('class' => 'pagings'),
	),
