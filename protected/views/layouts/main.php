...
<header>
  <div class="insideInner">
	...
	<div class="loginTop"><?php echo CHtml::link('Login', array('account/login'), array('class'=> 'loginbtn')); ?></div>
        ...
        'action'=>array('account/businessfinder'),
        //'method'=>'get',
        'id'=>'findparty-form',
	...
	<div class="btm">
	  <input name="addressInput" type="text" id="addressInput" class="inputBoxG">
	</div>
	</div>
	<div class="floatLeft">
	<div class="top"><strong>Search for</strong> (e.g.  party, dinner etc.)</div>
	<div class="btm">
	  <input name="nameInput" type="text" id="nameInput" class="inputBox">
	</div></div>
        <?php echo CHtml::submitButton('Search', array('name' => 'SearchSubmit', 'class' => 'btn'));?>
