			    ...
			    <table cellpadding="0" cellspacing="0" border="0" align="center" width="650" style="font-family: Georgia, serif;" class="header">
			      <tr>
			        <td bgcolor="#FFFFFF" height="115" align="center">
                                                <?php echo CHtml::imageButton('http://www.notesforus.com/images/logo.gif', array('type'=>'image')); ?>
            <p style="color: #1d4272; font: normal 11px Georgia, serif; margin: 0; padding: 0; line-height: 11px;"><singleline label="Title">Learn With Us!</singleline></p>
			        </td>
			      </tr>
				  <tr>
							...
							<td valign="top" style="padding: 0; margin: 0">
								...
								<tr>
									<td style="padding: 25px 0 0;" align="left">			
										<h2 style="color:#1d4272 !important; font-weight: normal; margin: 0; padding: 0; font-style: italic; line-height: 30px; font-size: 20px;font-family: Georgia, serif; "><singleline label="Title">Welcome <?php echo $model->firstName;?> to Notes For Us</singleline></h2>
									</td>
								</tr>
								<tr>
									<td style="padding: 15px 0 15px; border-bottom: 1px solid #1d4272;" valign="top"> 										
										...
										<p><multiline label="Description">We hope you enjoy your stay, please copy the verification code: <?php echo $model->verify_code; ?><br>Please copy this code, and enter it into the account verification page. <br>Thank You</multiline></p>
									</td>
								</tr>
								</table>
							</td>
				...
				<table cellpadding="0" cellspacing="0" border="0" align="center" width="650" style="font-family: Georgia, serif; line-height: 10px;" bgcolor="#698291" class="footer">
			      <tr>
			        <td bgcolor="#1d4272" align="center" style="padding: 15px 0 10px; font-size: 11px; color:#fff; margin: 0; line-height: 1.2;font-family: Georgia, serif;" valign="top">
						<p style="padding: 0; font-size: 11px; color:#fff; margin: 0; font-family: Georgia, serif;"> <singleline label="Title"><?php echo $model->firstName; ?>,</singleline></p>
