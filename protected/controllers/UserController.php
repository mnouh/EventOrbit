...
class UserController extends Controller {
    ...
    public function accessRules() {
        return array(
            array('allow', // allow all users to perform 'index' and 'view' actions
                'actions' => array('index', 'view', 'contacts', 'events'),
                'users' => array('*'),
            ),
    ...
    public function actionView() {
        ...
        $lookup = Yii::app()->request->getQuery('lookup');
        $model = User::model()->find("lookup ='" . $lookup . "'");
        if ($model === null)
  ...
  $sort->attributes = array(
    ...
    'criteria'=>array(
        'condition'=>'user_id='.$model->id.' AND rating LIKE "%'.$rating.'"',
  ...
  $sort->attributes = array(
    ...
    $sortRsvp = new CSort();
  $sortRsvp->attributes = array(
    '*', // add all of the other columns as sortable
  );
    
    $rsvpDataProvider=new CActiveDataProvider('Events', array(
    'criteria'=>array(
        //'order'=>'date_created ASC',
        'alias' => 'Events',
        'join' => 'LEFT JOIN tbl_rsvps r ON r.event_id=Events.id',
        'condition'=>'r.user_id='.$model->id.' AND r.status = 0',
    ...
    'pagination'=>array(
        ...
        $this->render('events', array(
            'model' => $model,
            'dataProvider' => $dataProvider,
            'rsvpDataProvider' => $rsvpDataProvider,
