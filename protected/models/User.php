...
class User extends CActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            ...
            'reviewsCountFive' => array(self::STAT, 'Reviews', 'user_id', 'condition'=>'rating=5'),
            'reviewsCountFour' => array(self::STAT, 'Reviews', 'user_id', 'condition'=>'rating=4'),
            'reviewsCountThree' => array(self::STAT, 'Reviews', 'user_id', 'condition'=>'rating=3'),
            'reviewsCountTwo' => array(self::STAT, 'Reviews', 'user_id', 'condition'=>'rating=2'),
            'reviewsCountOne' => array(self::STAT, 'Reviews', 'user_id', 'condition'=>'rating=1'),
            'eventsCount' => array(self::STAT, 'Events', 'user_id'),
            'rsvpCount' => array(self::STAT, 'Rsvps', 'user_id', 'condition' => 'status=0'),
            'discussionCount' => array(self::STAT, 'Eventdiscuss', 'user_id'),
    ...
    protected function beforeSave() {
        ...
        if ($this->isNewRecord) {
            ...
            $this->lookup = $str1;
            $this->joined_date = new CDbExpression('NOW()');
