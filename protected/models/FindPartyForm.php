 ...
 */
class FindPartyForm extends CFormModel
{
	//public $lat;
        //public $lng;
        //public $radius;
	...
	public function rules()
	{
		return array(
			// name, email, subject and body are required
                        array('addressInput', 'compare','compareValue'=>'Address, Neighborhood, City, State or Zip', 'operator'=>'!=' ),
                        array('addressInput', 'required'),
                        //array('id', 'numerical'),
                        /*array('lat', 'required'),
                        array('lng', 'required'),
